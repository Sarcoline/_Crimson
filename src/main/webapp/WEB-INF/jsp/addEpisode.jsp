        ...
        <div class="uk-width-1-1">
            ...
            <form:form modelAttribute="episode" method="POST" enctype="utf8" class="uk-form uk-form-stacked">
                ...
                <div class="uk-form-row">
                    ...
                    <form:input path="title" class="uk-width-1-2 uk-form-large"
                                type="text"
                                name='title'
                                placeholder="Title"/>
                ...
                <div class="uk-form-row">
                    ...
                    <form:textarea path="episodeSummary"
                ...
                <div class="uk-form-row">
                    ...
                    <form:input path="releaseDate" class="uk-form-large"
                ...
                <div class="uk-form-row">
                    ...
                    <form:input path="number" class="uk-form-large"
                ...
                <div class="uk-form-row">
                    ...
                    <form:input path="season" class="uk-form-large"
                                name='season' type="number" style="width: 50px;"
                                placeholder="Episode season"/>
                </div>
                <form:input path="idTvShow" value="${idTvShow}" type="hidden"/>
                <a href="<c:url value="/tv/${slug}/edit/episodes"/>"
