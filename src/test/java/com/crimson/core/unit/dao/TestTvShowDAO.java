...
public class TestTvShowDAO {
    ...
    @Test
    public void addUser2TvShowTest() throws Exception{
        //given
        TvShow tvShow = new TvShow();
        User user = new User();
        when(sessionFactory.getCurrentSession()).thenReturn(session);
    ...
    @Test
    public void addGenre2TvShowTest() throws Exception{
        //given
        TvShow tvShow = new TvShow();
    ...
    @Test
    public void addEpisode2TvShowTest() throws Exception{
        //given
        TvShow tvShow = new TvShow();
    ...
    @Test
    public void addRating2TvShowTest() throws Exception{
        //given
        TvShow tvShow = new TvShow();
    ...
    public void getUsersTest() throws Exception{
        ...
        when(session.createQuery(hql)).thenReturn(query);
        when(query.setParameter(0, tvShow.getId())).thenReturn(query);
        ...
        verify(sessionFactory, times(1)).getCurrentSession();
        verify(session, times(1)).createQuery(hql);
        verify(query, times(1)).setParameter(0, tvShow.getId());
        verify(query, times(1)).getResultList();
    }
